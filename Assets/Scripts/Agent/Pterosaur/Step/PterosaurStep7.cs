...
public class PterosaurStep7 : Step
{
    private Vector3 fixedPos;
    #region Public Function
    public PterosaurStep7(PterosaurBehaviour pterosaurBehaviour)
    {
        // TODO: Complete member initialization
        this.pterosaurBehaviour = pterosaurBehaviour;
        pterosaurStep = E_PterosaurStep.Step7;
    ...
    public override void UpdateStep()
    {
        ...
        switch (pState)
        {
            ...
            case E_PterosaurState.Run:
                Run();
                break;
            case E_PterosaurState.XXX:
                XXX();
                break;
            case E_PterosaurState.XXXBreak:
                XXXBreak();
                break;
    ...
    {
        AnimatorStateInfo info = animator.GetCurrentAnimatorStateInfo(0);
        if (!info.IsName("attack_xxx_break"))
        {
