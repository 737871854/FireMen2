...
public class PterosaurStep8 : Step
{
    private Vector3 fixedPos;
    #region Public Function
    public PterosaurStep8(PterosaurBehaviour pterosaurBehaviour)
    {
        // TODO: Complete member initialization
        this.pterosaurBehaviour = pterosaurBehaviour;
        pterosaurStep = E_PterosaurStep.Step8;
    ...
    public override void UpdateStep()
    {
        ...
        switch (pState)
        {
            ...
            case E_PterosaurState.Run:
                Run();
                break;
            case E_PterosaurState.Climb:
                Climb();
                break;
            case E_PterosaurState.ClimbBreak:
                ClimbBreak();
                break;
    ...
    private void ClimbBreak()
    {
        AnimatorStateInfo info = animator.GetCurrentAnimatorStateInfo(0);
        if (!info.IsName("attack_climb_break"))
        {
