 ...
 * 简    介:    
 * 
 * 创建标识：   Pancake 2018/4/24 9:13:17
 * 
 * 修改描述：   
 * 
 */
...
public class FarmBattleScene : IBattleScene
{
    // 镜头一两小孩路线
    ...
    [SerializeField]
    private Transform mWolfHoldPoint;

    private List<UselessCitizen> citizenList;

    private bool mIsInit;

    public Transform wolfHoldPoint { get { return mWolfHoldPoint; } }
