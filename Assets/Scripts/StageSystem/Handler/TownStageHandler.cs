 ...
 * 
 * 文件名称：   NormalStageHandler.cs
 * 
 * 简    介:    
 * 
 * 创建标识：   Pancake 2018/3/5 9:56:03
 * 
 * 修改描述：   
 * 
 */
...
public class TownStageHandler : IStageHandler
{
    ...
    public TownStageHandler(StageSystem stageSystem, int lv) : base(stageSystem, lv)
    {
