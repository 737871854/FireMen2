...
public class AnimatorWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("GetBehaviours", GetBehaviours),
	...
	static int GetFloat(IntPtr L)
	{
		...
		if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(Animator), typeof(string)))
		{
		...
		else if (count == 2 && LuaScriptMgr.CheckTypes(L, 1, typeof(Animator), typeof(int)))
		{
			Animator obj = (Animator)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Animator");
	...
	static int SetBool(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Animator), typeof(string), typeof(bool)))
		{
			Animator obj = (Animator)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Animator");
			string arg0 = LuaScriptMgr.GetString(L, 2);
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Animator), typeof(int), typeof(bool)))
		{
			Animator obj = (Animator)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Animator");
			int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
			bool arg1 = LuaDLL.lua_toboolean(L, 3);
	...
	static int SetInteger(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Animator), typeof(string), typeof(int)))
		{
			Animator obj = (Animator)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Animator");
			string arg0 = LuaScriptMgr.GetString(L, 2);
	...
	static int GetBehaviours(IntPtr L)
	{
		...
		StateMachineBehaviour[] o = obj.GetBehaviours(arg0,arg1);
