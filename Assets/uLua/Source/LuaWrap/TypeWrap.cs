...
public class TypeWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("GetEnumNames", GetEnumNames),
			new LuaMethod("GetEnumValues", GetEnumValues),
			new LuaMethod("GetEnumUnderlyingType", GetEnumUnderlyingType),
			new LuaMethod("IsEnumDefined", IsEnumDefined),
			new LuaMethod("GetEnumName", GetEnumName),
			...
			new LuaMethod("IsEquivalentTo", IsEquivalentTo),
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("IsConstructedGenericType", get_IsConstructedGenericType, null),
			...
			new LuaField("GenericTypeArguments", get_GenericTypeArguments, null),
			new LuaField("IsSecurityCritical", get_IsSecurityCritical, null),
			new LuaField("IsSecuritySafeCritical", get_IsSecuritySafeCritical, null),
			new LuaField("IsSecurityTransparent", get_IsSecurityTransparent, null),
	...
	static int get_IsConstructedGenericType(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name IsConstructedGenericType");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index IsConstructedGenericType on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.IsConstructedGenericType);
		return 1;
	}
	...
	static int get_GenericTypeArguments(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name GenericTypeArguments");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index GenericTypeArguments on a nil value");
			}
		}

		LuaScriptMgr.PushArray(L, obj.GenericTypeArguments);
		return 1;
	}
	...
	static int get_IsSecurityCritical(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name IsSecurityCritical");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index IsSecurityCritical on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.IsSecurityCritical);
		return 1;
	}
	...
	static int get_IsSecuritySafeCritical(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name IsSecuritySafeCritical");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index IsSecuritySafeCritical on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.IsSecuritySafeCritical);
		return 1;
	}
	...
	static int get_IsSecurityTransparent(IntPtr L)
	{
		...
		if (obj == null)
		{
			...
			if (types == LuaTypes.LUA_TTABLE)
			{
				LuaDLL.luaL_error(L, "unknown member name IsSecurityTransparent");
			}
			else
			{
				LuaDLL.luaL_error(L, "attempt to index IsSecurityTransparent on a nil value");
			}
		}

		LuaScriptMgr.Push(L, obj.IsSecurityTransparent);
		return 1;
	}
	...
	static int GetType(IntPtr L)
	{
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(string), typeof(Func<System.Reflection.AssemblyName,System.Reflection.Assembly>), typeof(Func<System.Reflection.Assembly,string,bool,Type>)))
		{
			string arg0 = LuaScriptMgr.GetString(L, 1);
			Func<System.Reflection.AssemblyName,System.Reflection.Assembly> arg1 = null;
			LuaTypes funcType2 = LuaDLL.lua_type(L, 2);

			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Func<System.Reflection.AssemblyName,System.Reflection.Assembly>)LuaScriptMgr.GetLuaObject(L, 2);
			}
			else
			{
				...
				arg1 = (param0) =>
				{
					...
					func.EndPCall(top);
					return (System.Reflection.Assembly)objs[0];
				};
			}

			Func<System.Reflection.Assembly,string,bool,Type> arg2 = null;
			LuaTypes funcType3 = LuaDLL.lua_type(L, 3);

			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Func<System.Reflection.Assembly,string,bool,Type>)LuaScriptMgr.GetLuaObject(L, 3);
			}
			else
			{
		...
		else if (count == 4)
		{
			...
			if (funcType2 != LuaTypes.LUA_TFUNCTION)
			{
				 arg1 = (Func<System.Reflection.AssemblyName,System.Reflection.Assembly>)LuaScriptMgr.GetNetObject(L, 2, typeof(Func<System.Reflection.AssemblyName,System.Reflection.Assembly>));
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 2);
			...
			if (funcType3 != LuaTypes.LUA_TFUNCTION)
			{
				 arg2 = (Func<System.Reflection.Assembly,string,bool,Type>)LuaScriptMgr.GetNetObject(L, 3, typeof(Func<System.Reflection.Assembly,string,bool,Type>));
			}
			else
			{
				LuaFunction func = LuaScriptMgr.GetLuaFunction(L, 3);
			...
			Type o = Type.GetType(arg0,arg1,arg2,arg3);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else if (count == 5)
		{
			...
			Type o = Type.GetType(arg0,arg1,arg2,arg3,arg4);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
		else
	...
	static int GetEnumUnderlyingType(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		Type obj = LuaScriptMgr.GetTypeObject(L, 1);
		Type o = obj.GetEnumUnderlyingType();
		LuaScriptMgr.Push(L, o);
		return 1;
	}
