...
public class stringWrap
{
	public static void Register(IntPtr L)
	{
		LuaMethod[] regs = new LuaMethod[]
		{
			...
			new LuaMethod("IsNullOrWhiteSpace", IsNullOrWhiteSpace),
	...
	static int Join(IntPtr L)
	{
		...
		if (count == 2)
		{
			...
			IEnumerable<string> arg1 = (IEnumerable<string>)LuaScriptMgr.GetNetObject(L, 2, typeof(IEnumerable<string>));
			string o = string.Join(arg0,arg1);
		...
		else if (LuaScriptMgr.CheckTypes(L, 1, typeof(string)) && LuaScriptMgr.CheckParamsType(L, typeof(string), 2, count - 1))
		{
	...
	static int IsNullOrWhiteSpace(IntPtr L)
	{
		LuaScriptMgr.CheckArgsCount(L, 1);
		string arg0 = LuaScriptMgr.GetLuaString(L, 1);
		bool o = string.IsNullOrWhiteSpace(arg0);
		LuaScriptMgr.Push(L, o);
		return 1;
	}
	...
	static int Split(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(string), typeof(char[]), typeof(int)))
		{
			string obj = (string)LuaScriptMgr.GetNetObjectSelf(L, 1, "string");
	...
	static int Replace(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(string), typeof(char), typeof(char)))
		{
			string obj = (string)LuaScriptMgr.GetNetObjectSelf(L, 1, "string");
			char arg0 = (char)LuaDLL.lua_tonumber(L, 2);
	...
	static int Format(IntPtr L)
	{
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(IFormatProvider), typeof(string), typeof(object)))
		{
		...
		else if (count == 4 && LuaScriptMgr.CheckTypes(L, 1, typeof(IFormatProvider), typeof(string), typeof(object), typeof(object)))
		{
			IFormatProvider arg0 = (IFormatProvider)LuaScriptMgr.GetLuaObject(L, 1);
			string arg1 = LuaScriptMgr.GetString(L, 2);
			object arg2 = LuaScriptMgr.GetVarObject(L, 3);
		...
		else if (count == 4 && LuaScriptMgr.CheckTypes(L, 1, typeof(string), typeof(object), typeof(object), typeof(object)))
		{
			string arg0 = LuaScriptMgr.GetString(L, 1);
			object arg1 = LuaScriptMgr.GetVarObject(L, 2);
			object arg2 = LuaScriptMgr.GetVarObject(L, 3);
		...
		else if (count == 5)
		{
			...
			string o = string.Format(arg0,arg1,arg2,arg3,arg4);
			LuaScriptMgr.Push(L, o);
			return 1;
		}
	...
	static int Concat(IntPtr L)
	{
		...
		if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(IEnumerable<string>)))
		{
			IEnumerable<string> arg0 = (IEnumerable<string>)LuaScriptMgr.GetLuaObject(L, 1);
