...
public class DG_Tweening_DOTweenWrap
{
	...
	static int To(IntPtr L)
	{
		...
		if (count == 4 && LuaScriptMgr.CheckTypes(L, 1, typeof(DG.Tweening.Core.DOGetter<float>), typeof(DG.Tweening.Core.DOSetter<float>), typeof(float), typeof(float)))
		{
		...
		else if (count == 4 && LuaScriptMgr.CheckTypes(L, 1, typeof(DG.Tweening.Core.DOGetter<Quaternion>), typeof(DG.Tweening.Core.DOSetter<Quaternion>), typeof(LuaTable), typeof(float)))
		{
