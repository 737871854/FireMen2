...
public class MaterialWrap
{
	...
	static int _CreateMaterial(IntPtr L)
	{
		...
		if (count == 1 && LuaScriptMgr.CheckTypes(L, 1, typeof(Shader)))
		{
	...
	static int SetInt(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(int)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string arg0 = LuaScriptMgr.GetString(L, 2);
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(int), typeof(int)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
			int arg1 = (int)LuaDLL.lua_tonumber(L, 3);
	...
	static int SetTexture(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(Texture)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string arg0 = LuaScriptMgr.GetString(L, 2);
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(int), typeof(Texture)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
			Texture arg1 = (Texture)LuaScriptMgr.GetLuaObject(L, 3);
	...
	static int SetBuffer(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(ComputeBuffer)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string arg0 = LuaScriptMgr.GetString(L, 2);
		...
		else if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(int), typeof(ComputeBuffer)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			int arg0 = (int)LuaDLL.lua_tonumber(L, 2);
			ComputeBuffer arg1 = (ComputeBuffer)LuaScriptMgr.GetLuaObject(L, 3);
	...
	static int SetFloatArray(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(List<float>)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string arg0 = LuaScriptMgr.GetString(L, 2);
	...
	static int SetColorArray(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(List<Color>)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string arg0 = LuaScriptMgr.GetString(L, 2);
	...
	static int SetVectorArray(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(List<Vector4>)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string arg0 = LuaScriptMgr.GetString(L, 2);
	...
	static int SetMatrixArray(IntPtr L)
	{
		...
		if (count == 3 && LuaScriptMgr.CheckTypes(L, 1, typeof(Material), typeof(string), typeof(List<Matrix4x4>)))
		{
			Material obj = (Material)LuaScriptMgr.GetUnityObjectSelf(L, 1, "Material");
			string arg0 = LuaScriptMgr.GetString(L, 2);
